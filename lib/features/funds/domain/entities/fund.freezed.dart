...
class _$FundImpl implements _Fund {
  ...
  @override
  String toString() {
    return 'Fund(id: $id, name: $name, minimumAmount: $minimumAmount, category: $category, description: $description)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, minimumAmount, category, description);
...
abstract class _Fund implements Fund {
  const factory _Fund(
      ...
      final String description}) = _$FundImpl;
